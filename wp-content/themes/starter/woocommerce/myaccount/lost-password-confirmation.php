...
<div class="gm_woo-notices-wrapper">
    <?php wc_print_notice( esc_html__( 'Password reset email has been sent.', 'woocommerce' ) ); ?>
</div>

<div class="gm_woo-myaccount-reset-password gm_woo-myaccount-reset-password--confirmation-message uk-panel uk-panel-box uk-panel-box-white">
