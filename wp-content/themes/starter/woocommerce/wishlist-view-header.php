...
<form id="yith-wcwl-form" action="<?php echo esc_attr( $form_action ); ?>" method="post" class="gm_woo-wishlist-form uk-form uk-form-stacked woocommerce yith-wcwl-form wishlist-fragment" data-fragment-options="<?php echo esc_attr( json_encode( $fragment_options ) ); ?>">

	<?php do_action( 'yith_wcwl_before_wishlist', $wishlist ); ?>
