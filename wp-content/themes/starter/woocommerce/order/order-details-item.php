...
<div class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'gm_table-list__row woocommerce-table__line-item order_item', $item, $order ) ); ?>">

	<div class="gm_table-list__cell gm_table-list__cell--product">
