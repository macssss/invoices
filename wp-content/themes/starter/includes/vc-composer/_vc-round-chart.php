<?php
	...
	vc_remove_param( 'vc_round_chart', 'title' );
	vc_remove_param( 'vc_round_chart', 'style' );
	
	$vc_round_chart_attributes = array(
		array(
			'type' => 'dropdown',
	...
	vc_add_params( 'vc_round_chart', $vc_round_chart_attributes );
