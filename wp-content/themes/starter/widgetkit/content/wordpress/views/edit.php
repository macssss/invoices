    ...
    <div class="uk-form-row">
        ...
        <div class="uk-form-controls">
            ...
            <p class="uk-form-controls-condensed">
	            <label><input type="checkbox" ng-model="content.data['only_sticky']"> {{'Only Sticky' | trans}}</label>
	        </p>
        </div>
    </div>
    
    <div class="uk-form-row">
        <label class="uk-form-label" for="wk-default-image-id">{{'Default Image ID' | trans}}</label>
        <div class="uk-form-controls">
            <input id="wk-default-image-id" class="uk-form-width-large" type="number" ng-model="content.data['default_image_id']">
        </div>
    </div>
    
    <div class="uk-form-row">
        <label class="uk-form-label" for="wk-default-title-limit">{{'Title Limit' | trans}}</label>
        <div class="uk-form-controls">
            <input id="wk-default-title-limit" class="uk-form-width-large" type="number" ng-model="content.data['title_limit']">
        </div>
    </div>
    
    <div class="uk-form-row">
        <label class="uk-form-label" for="wk-default-content-limit">{{'Content Limit' | trans}}</label>
        <div class="uk-form-controls">
            <input id="wk-default-content-limit" class="uk-form-width-large" type="number" ng-model="content.data['content_limit']">
        </div>
    </div>
            ...
            <div class="uk-grid uk-grid-small uk-grid-width-1-2">
                ...
                <div>
                    <select class="uk-width-1-1" ng-model="content.data['date']">
                        ...
                        <option value="event_date">{{'Event Date' | trans}}</option>
                    </select>
                </div>
            </div>
