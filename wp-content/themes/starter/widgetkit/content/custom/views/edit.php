<div ng-controller="customCtrl as custom">
    ...
    <div class="uk-grid uk-grid-divider uk-form uk-form-stacked" data-uk-grid-margin>
        <div ng-class="vm.name == 'contentCtrl' ? 'wk-width-xlarge-1-4' : ''" class="uk-width-medium-1-3">
            ...
            <div class="wk-panel-marginless">
                ...
                <div class="uk-form-row uk-margin-large-top">
                    ...
                    <div class="uk-form-controls uk-form-controls-condensed">
                        <label class="uk-flex uk-flex-middle {{ content.data['reverse'] ? '':'uk-text-muted'}}"><input class="uk-margin-small-right" type="checkbox" ng-model="content.data['reverse']" ng-true-value="1" ng-false-value="0"> {{'Reverse Order' | trans}}</label>
                    </div>
                    <div class="uk-form-controls uk-form-controls-condensed">
        ...
        <div ng-class="vm.name == 'contentCtrl' ? 'wk-width-xlarge-3-4' : ''" class="uk-width-medium-2-3" ng-show="item">
            ...
            <div class="uk-form-row">
                <label class="uk-form-label" for="wk-image-alt">{{'Image Alt' | trans}}</label>
                <div class="uk-form-controls">
                    <input id="wk-image-alt" class="uk-width-1-1" type="text" ng-model="item.image_alt">
                </div>
            </div>
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls uk-form-controls-text">
                    <label><input type="checkbox" ng-model="item.link_target"> {{'Open link in a new window' | trans}}</label>
                </div>
            </div>
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls uk-form-controls-text">
                    <label><input type="checkbox" ng-model="item.link_nofollow"> {{'Set rel nofollow for link' | trans}}</label>
                </div>
            </div>
            
            <div class="uk-form-row">
                <label class="uk-form-label" for="wk-class">{{'Class' | trans}}</label>
                <div class="uk-form-controls">
                    <input id="wk-class" class="uk-width-1-1" type="text" ng-model="item.class">
                </div>
            </div>
