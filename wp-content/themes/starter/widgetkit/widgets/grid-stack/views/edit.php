    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            <li>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-animation-delay">{{'Animation Delay' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-animation-delay" class="uk-form-width-medium" type="text" ng-model="widget.data['animation_delay']">
                    </div>
                </div>
