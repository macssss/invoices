    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            <li>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.grid == 'default'">
                            <label>
                                <select class="uk-form-width-small" ng-model="widget.data['gutter_v']">
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.animation != 'none'">
                            <label>
                                <input id="wk-animation-delay" class="uk-form-width-small" type="text" ng-model="widget.data['animation_delay']">
                                {{'Delay' | trans}}
                            </label>
                        </p>
                    </div>
            ...
            <li>
                ...
                <div class="uk-form-row" ng-if="(['button', 'secondary', 'dark', 'primary', 'button-link'].indexOf(widget.data.link_style) > -1)">
            ...
            <h3 class="wk-form-heading">{{'Lightbox' | trans}}</h3>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
					    ...
					    <p class="uk-form-controls-condensed" ng-if="widget.data.lightbox == 'slideshow'">
		                    <label>
		                        <select class="uk-form-width-small" ng-model="widget.data['lightbox_nav_image_size']">
		                            <option value="full">full</option>
					                <?php foreach ( get_intermediate_image_sizes() as $gm_image_size ) : ?>
					                    <option value="<?php echo $gm_image_size; ?>"><?php echo $gm_image_size; ?></option>
					                <?php endforeach; ?>
		                        </select>
		                        {{'Nav Image Size' | trans}}
		                    </label>
		                </p>
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.lightbox == 'slideshow'">
                            <label><input type="checkbox" ng-model="widget.data['lightbox_title']"> {{'Show title' | trans}}</label>
                        </p>
                        
                        <p class="uk-form-controls-condensed" ng-if="widget.data.lightbox == 'slideshow'">
                            <label><input type="checkbox" ng-model="widget.data['lightbox_subtitle']"> {{'Show subtitle' | trans}}</label>
                        </p>
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.lightbox == 'slideshow'">
                            <label><input type="text" class="uk-form-width-small" ng-model="widget.data['lightbox_title_class']"> {{'Title class' | trans}}</label>
                        </p>
                        
                        <p class="uk-form-controls-condensed" ng-if="widget.data.lightbox == 'slideshow'">
                            <label>
                                <select class="uk-form-width-small" ng-model="widget.data['lightbox_subtitle_size']">
                                    <option value="panel">{{'Default' | trans}}</option>
                                    <option value="h1">H1</option>
                                    <option value="h2">H2</option>
                                    <option value="h3">H3</option>
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.lightbox == 'slideshow'">
                            <label><input type="text" class="uk-form-width-small" ng-model="widget.data['lightbox_subtitle_class']"> {{'Subtitle class' | trans}}</label>
                        </p>
                        
                        <p class="uk-form-controls-condensed" ng-if="widget.data.lightbox == 'slideshow'">
                            <label><input type="checkbox" ng-model="widget.data['lightbox_titles_reverse']"> {{'Titles reverse' | trans}}</label>
                        </p>
                        
                        <p class="uk-form-controls-condensed" ng-if="widget.data.lightbox == 'slideshow'">
                            <label><input type="checkbox" ng-model="widget.data['lightbox_titles_remove_offset']"> {{'Titles remove offset' | trans}}</label>
                        </p>
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data.lightbox == 'slideshow'">
		                    <label>
		                        <select class="uk-form-width-small" ng-model="widget.data['lightbox_text_align']">
		                            <option value="left">{{'Left' | trans}}</option>
		                            <option value="right">{{'Right' | trans}}</option>
		                            <option value="center">{{'Center' | trans}}</option>
		                        </select>
                ...
                <div class="uk-form-row">
			        <label class="uk-form-label" for="wk-lightbox-image-size">{{'Image Size' | trans}}</label>
			        <div class="uk-form-controls">
			            <select id="wk-lightbox-image-size" class="uk-form-width-medium" ng-model="widget.data['lightbox_image_size']">
				            <option value="full">full</option>
			                <?php foreach ( get_intermediate_image_sizes() as $gm_image_size ) : ?>
			                    <option value="<?php echo $gm_image_size; ?>"><?php echo $gm_image_size; ?></option>
			                <?php endforeach; ?>
                ...
                <div class="uk-form-row" ng-if="(['button', 'secondary', 'dark', 'primary', 'button-link'].indexOf(widget.data.lightbox_style) > -1)">
                    <label class="uk-form-label" for="wk-lightbox_size">{{'Size' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-lightbox_size" class="uk-form-width-medium" ng-model="widget.data['lightbox_size']">
                            <option value="default">{{'Button Default' | trans}}</option>
                            <option value="mini">{{'Button Mini' | trans}}</option>
                            <option value="small">{{'Button Small' | trans}}</option>
                            <option value="large">{{'Button Large' | trans}}</option>
