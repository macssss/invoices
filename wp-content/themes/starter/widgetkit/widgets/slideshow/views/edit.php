    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label">{{'Overlay' || trans}}</label>
                    <div class="uk-form-controls uk-form-controls-text">
                        <label><input type="checkbox" ng-model="widget.data['overlay']"> {{'Yes' || trans}}</label>
                    </div>
                </div>
                
                <div class="uk-form-row" ng-if="widget.data.overlay === true">
                    <label class="uk-form-label">{{'Overlay Full' || trans}}</label>
                    <div class="uk-form-controls uk-form-controls-text">
                        <label><input type="checkbox" ng-model="widget.data['overlay_full']"> {{'Yes' || trans}}</label>
                    </div>
                </div>
				
				<div class="uk-form-row" ng-if="widget.data.overlay === true && widget.data.overlay_full === false">
                    <label class="uk-form-label">{{'Overlay Stretch' || trans}}</label>
                    <div class="uk-form-controls uk-form-controls-text">
                        <label><input type="checkbox" ng-model="widget.data['overlay_stretch']"> {{'Yes' || trans}}</label>
                    </div>
                </div>
                
                <div class="uk-form-row" ng-if="widget.data.overlay === true">
                    <label class="uk-form-label">{{'Overlay Inner Offset' || trans}}</label>
                    <div class="uk-form-controls uk-form-controls-text">
                        <label><input type="checkbox" ng-model="widget.data['overlay_inn_offset']"> {{'Yes' || trans}}</label>
                    </div>
                </div>
                
                <div class="uk-form-row" ng-if="widget.data.overlay === true">
                    <label class="uk-form-label">{{'Overlay Outer Offset' || trans}}</label>
                    <div class="uk-form-controls uk-form-controls-text">
                        <label><input type="checkbox" ng-model="widget.data['overlay_out_offset']"> {{'Yes' || trans}}</label>
                    </div>
                </div>
                ...
                <div class="uk-form-row" ng-if="widget.data.overlay === true">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-overlay-position" class="uk-form-width-medium" ng-model="widget.data['overlay_position']">
                            ...
                            <option value="bottom-left">{{'Bottom Right' | trans}}</option>
                            <option value="bottom-right">{{'Bottom Right' | trans}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="uk-form-row" ng-if="widget.data.overlay === true">
                    <label class="uk-form-label">{{'Show panel background' | trans}}</label>
                    <div class="uk-form-controls uk-form-controls-text">
                        <label><input type="checkbox" ng-model="widget.data['overlay_background']"> {{'Yes' || trans}}</label>
                    </div>
                </div>
                
                <h3 class="wk-form-heading" ng-if="widget.data.overlay === true">{{'Content Width' | trans}}</h3>
                
                <div class="uk-form-row" ng-if="widget.data.overlay === true">
                    <label class="uk-form-label" for="wk-content-width">{{'Phone Portrait' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-content-width" class="uk-form-width-medium" ng-model="widget.data['content_width']">
                ...
                <div class="uk-form-row" ng-if="widget.data.overlay === true">
                    <label class="uk-form-label" for="wk-content-width-small">{{'Phone Landscape' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-content-width-small" class="uk-form-width-medium" ng-model="widget.data['content_width_small']">
                ...
                <div class="uk-form-row" ng-if="widget.data.overlay === true">
                    <label class="uk-form-label" for="wk-content-width-medium">{{'Tablet' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-content-width-medium" class="uk-form-width-medium" ng-model="widget.data['content_width_medium']">
                            <option value="">{{'Inherit' | trans}}</option>
                            <option value="1-2">50%</option>
                            <option value="3-5">60%</option>
                            <option value="2-3">66%</option>
                ...
                <div class="uk-form-row" ng-if="widget.data.overlay === true">
                    <label class="uk-form-label" for="wk-content-width-large">{{'Desktop' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-content-width-large" class="uk-form-width-medium" ng-model="widget.data['content_width_large']">
                            <option value="">{{'Inherit' | trans}}</option>
                ...
                <div class="uk-form-row" ng-if="widget.data.overlay === true">
                    <label class="uk-form-label" for="wk-content-width-xlarge">{{'Large Screens' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-content-width-xlarge" class="uk-form-width-medium" ng-model="widget.data['content_width_xlarge']">
                            <option value="">{{'Inherit' | trans}}</option>
                            <option value="1-3">33%</option>
                            <option value="2-5">40%</option>
                            <option value="1-2">50%</option>
