    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            ...
            <li>
                ...
                <h3 class="wk-form-heading">{{'Count' | trans}}</h3>
                
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-count-size">{{'Count Size' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-count-size" class="uk-form-width-medium" ng-model="widget.data['count_size']">
                            <option value="h1">H1</option>
                            <option value="h2">H2</option>
                            <option value="h3">H3</option>
                            <option value="h4">H4</option>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-count-before">{{'Count Before' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-count-before" class="uk-form-width-medium" type="text" ng-model="widget.data['count_before']">
                    </div>
                </div>
                
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-count-after">{{'Count After' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-count-after" class="uk-form-width-medium" type="text" ng-model="widget.data['count_after']">
                    </div>
                </div>
                
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-count-speed">{{'Count Speed' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-count-speed" class="uk-form-width-medium" type="text" ng-model="widget.data['count_speed']">
                    </div>
                </div>
                
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-count-class">{{'Count Class' | trans}}</label>
                    <div class="uk-form-controls">
                        <input id="wk-count-class" class="uk-form-width-medium" type="text" ng-model="widget.data['count_class']">
                    </div>
                </div>
