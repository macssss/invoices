...
// JS Options
$options = array();
$options[] = ($settings['infinite']) ? '\'loop\': true' : '';
$options[] = ($settings['center']) ? '\'centeredSlides\': true' : '';
$options[] = ($settings['autoplay']) ? '\'autoplay\': true ' : '';
$options[] = ($settings['autoplay'] && $settings['interval']) ? '\'autoplayDelay\': ' . $settings['interval'] : '';
$options[] = ($settings['autoplay'] && $settings['autoplay_pause']) ? '\'disableOnInteraction\': true' : '\'disableOnInteraction\': false' ;
...
<div class="gm_swiper<?php if ($settings['container_offset']): ?> gm_clear-container-offset<?php endif; ?> <?php echo $settings['class']; ?>" data-gm-swiper="<?php echo $options; ?>">

    <div class="uk-slidenav-position">
		
		<div class="gm_swiper-cont">
		    <div class="swiper-container gm_gutter-<?php echo $settings['gutter']; ?>">
		        <div class="swiper-wrapper <?php echo $grid; ?>">
	    ...
	    <a href="#" class="{wk}-slidenav <?php if ($settings['slidenav_contrast']) echo '{wk}-slidenav-contrast'; ?> {wk}-slidenav-previous {wk}-hidden-touch"></a>
	    <a href="#" class="{wk}-slidenav <?php if ($settings['slidenav_contrast']) echo '{wk}-slidenav-contrast'; ?> {wk}-slidenav-next {wk}-hidden-touch"></a>
	    <?php endif ?>
    </div>
