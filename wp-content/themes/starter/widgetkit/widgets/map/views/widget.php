...
<script type="widgetkit/map" data-id="<?php echo $map_id;?>" data-class="gm_map <?php echo $settings['class']; ?> {wk}-img-preserve<?php if ($settings['map_fullscreen']): ?> gm_map--fullscreen<?php endif; ?>" data-style="width:<?php echo $width?>;height:<?php echo $height?>;">
