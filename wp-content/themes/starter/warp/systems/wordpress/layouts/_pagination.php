...
if ($pages > 1) {
    ...
    $output[] = '<div class="uk-pagination-cont"><ul class="uk-pagination">';
    ...
    if ($page > 1) {
        ...
        $output[] = '<li><a href="'.$link.'"><i class="fas fa-angle-left"></i></a></li>';
    }
    ...
    if ($page < $pages) {
        $link     = ($type === 'posts') ? get_pagenum_link($page+1) : get_comments_pagenum_link($page+1);
        $output[] = '<li><a href="'.$link.'"><i class="fas fa-angle-right"></i></a></li>';
    }
