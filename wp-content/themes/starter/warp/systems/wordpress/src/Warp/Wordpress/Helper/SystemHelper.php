    ...
    public function ajaxSearch()
    {
        ...
        if (strlen($query) >= 3) {
            ...
            foreach ($wp_query->get_posts() as $post) {
				...
				$item_title = '<div class="gm_title">'.$post->post_title.'</div>';
                ...
                if ( $post->post_type == 'post' ){
                	...
                	foreach( $post_categories as $post_category ) {
			            ...
			            $post_categories_output[] = '<span class="gm_category category-' . $post_category->slug . '">' . esc_html( $post_category->name ) . '</span>';
			        }
            	}
                
                
                
                $item_content = '<div class="gm_inner">';
                
                	$item_content .= $content;
                	
                	if ( $post_categories_output ){
	                	$item_content .= ' ' . implode($post_categories_output, " ");
                	}
