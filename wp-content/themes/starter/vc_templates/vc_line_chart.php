...
$canvas_html = '<canvas class="gm_line-chart-canvas" width="1" height="1"></canvas>';
$legend_html = '';
if ( $legend ) {
...
if ( $legend ) {
	$output .= '<div class="gm_chart-inner uk-grid uk-grid-small uk-flex-middle" data-uk-grid-margin>';
		$output .= '<div class="uk-width-medium-3-4">' . $canvas_html . '</div>';
		$output .= '<div class="uk-width-medium-1-4">' . $legend_html . '</div>';
	$output .= '</div>';
}
